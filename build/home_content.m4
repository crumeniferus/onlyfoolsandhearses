		...
		<section id="content" class="body">
		 	<ol id="posts-list" class="hfeed">
				<li><article class="hentry">
					<header>
						<h2 class="entry-title"><a href="#" rel="bookmark" title="Permalink to this POST TITLE">Joining up with R H Carriagemasters of Dorset</a></h2>
				  </header>

					<footer class="post-info">
			 			<abbr class="published" title="2015-04-01T11:07:00-00:00"><!-- YYYYMMDDThh:mm:ss+ZZZZ -->
							1st April 2015
						</abbr>

						<address class="vcard author">
							By <a class="url fn" href="#">Ian Cheesbrough</a>
						</address>
					</footer><!-- /.post-info -->

					<div class="entry-content">
						<p>We recently added something a little different to the fleet of R H Carriagemasters with our yellow Reliant Robin in the style of Only Fools and Horses, and magnificently presented horse-drawn hearse. We are proud to be able to work so closely with such a well-respected hearse and limousine hire company.</p>
					</div><!-- /.entry-content -->
				</article></li>
